...
public class Personal_Task_Adapter extends ArrayAdapter<Task> {
    private Context context;
    private int resource;
    List<Task> tasks;
    String userId;
    public Personal_Task_Adapter(@NonNull Context context, int resource, List<Task> tasks, String userId) {
